function EGA215_954313_A2_Q4 
    clc
    
    tspan = 43200;
    
    [t , p] = ode45(@Q2, [0,tspan], [3.376454119345376e+04;9.788751445532175e+02; 0; -0.093571597217392; (2.692525829586533 + 1.2); 0]);
    ...
    t_max = t(21,1); %Time at max altitude
    t_min = t(38,1); %Time at min altiude
    V_max = V(1,21); %velocity at max altitude
    V_min = V(1,38); %Velocity at min altitude
    ...
    figure(7)
    hold on
    plot(p(:,1),p(:,2)) %Satellite trajectory 
